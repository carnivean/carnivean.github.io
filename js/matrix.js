...
function updateMatrixLeft(){
	...
	transform.c = parseFloat(mtx_transforms[2].value) || 0;
	transform.tx = parseFloat(mtx_transforms[3].value) || 0;
	transform.d = parseFloat(mtx_transforms[4].value) || 0;
	transform.e = parseFloat(mtx_transforms[5].value) || 0;
	transform.f = parseFloat(mtx_transforms[6].value) || 0;
	transform.ty = parseFloat(mtx_transforms[7].value) || 0;
	transform.g = parseFloat(mtx_transforms[8].value) || 0;
	transform.h = parseFloat(mtx_transforms[9].value) || 0;
	transform.i = parseFloat(mtx_transforms[10].value) || 0;
	transform.tz = parseFloat(mtx_transforms[11].value) || 0;
...
function updateMatrixRight(){
	...
	if(mtx_inputs[0].innerHTML==="x"){
	    ...
	    mtx_inputs[1].style.lineHeight = "";
			mtx_inputs[2].style.border = "";
	    mtx_inputs[2].style.width = "";
	    mtx_inputs[2].style.height = "";
	    mtx_inputs[2].style.lineHeight = "";

		mtx_outputs[0].style.background = "";
		mtx_outputs[1].style.background = "";
		mtx_outputs[2].style.background = "";
		mtx_outputs[0].style.color = "";
		mtx_outputs[1].style.color = "";
		mtx_outputs[2].style.color = "";
	    ...
	    mtx_inputs[1].style.lineHeight = "40px";
			mtx_inputs[2].style.border = "5px solid #DD3838";
	    mtx_inputs[2].style.width = "40px";
	    mtx_inputs[2].style.height = "40px";
	    mtx_inputs[2].style.lineHeight = "40px";
		...
		mtx_outputs[2].style.background = "#DD3838";
		mtx_outputs[2].style.color = "#FFF";
...
function calculate(x,y,z){
	...
	var x2 = a*x + b*y + c*z + tx;
	var y2 = d*x + e*y + f*z + ty;
	var z2 = g*x + h*y + i*z + tz;
...
multiplicationHover($("#mtx_expanded > div:nth-child(1)")[0],
$("#mtx_transform > input:nth-child(1)")[0], $("#mtx_input > div:nth-child(1)")[0]);
...
multiplicationHover($("#mtx_expanded > div:nth-child(10)")[0], $("#mtx_transform > div:nth-child(10)")[0], $("#mtx_input > div:nth-child(10)")[0]);
multiplicationHover($("#mtx_expanded > div:nth-child(11)")[0], $("#mtx_transform > div:nth-child(11)")[0], $("#mtx_input > div:nth-child(11)")[0]);
multiplicationHover($("#mtx_expanded > div:nth-child(12)")[0], $("#mtx_transform > div:nth-child(12)")[0], $("#mtx_input > div:nth-child(12)")[0]);
multiplicationHover($("#mtx_expanded > div:nth-child(13)")[0], $("#mtx_transform > div:nth-child(13)")[0], $("#mtx_input > div:nth-child(13)")[0]);
multiplicationHover($("#mtx_expanded > div:nth-child(14)")[0], $("#mtx_transform > div:nth-child(14)")[0], $("#mtx_input > div:nth-child(14)")[0]);
multiplicationHover($("#mtx_expanded > div:nth-child(15)")[0], $("#mtx_transform > div:nth-child(15)")[0], $("#mtx_input > div:nth-child(15)")[0]);
...
function draw(){
	...
	for(var i=0;i<bullets.length;i++){
		...
		var originalBullet = originalBullets[i];
		var newBullet = calculate(originalBullet.x,originalBullet.y, originalBullet.z);
	...
	for(var i=0;i<bullets.length;i++){
		...
		if(bullet.isHovered){
			...
			mtx_inputs[2].innerHTML = originalBullet.z.toFixed(1);
			updateMatrixRight();
		}
